...
from POM.add_product import AdminPage
#from POM.welcomeadminpage import WelcomePage
# from POM.viewretailerpage import  ViewRetailerPage
...
def _config(request):
    class TestConfigurations:
        url = "http://49.249.28.218:8081/AppServer/Supply_Chain_Management/"
        username = "admin"
        password = "Admin123"
    ...
    if exe_env.upper() == "TEST":
        ...
        print("Execution evnironment is STAGE")
...
def pages(driver):
    class Pages:
        ...
        #welcomeadminpage = WelcomeAdminPage(driver)
        # viewretailerpage = ViewRetailerPage(driver)
